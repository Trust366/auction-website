      ...
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        <div>
          ...
          <p className="text-xl text-stone-600">
            Welcome to TrustysBid, the ultimate destination for online auctions
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            At TrustysBid, our mission is to revolutionize the way people buy and
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
          TrustysBid, founded by Trust Elechi, was born from a passion for connecting people with unique and valuable items. We're a growing team focused on building a trusted platform that makes buying and selling through auctions easy, fun, and rewarding for everyone.
          </p>
        </div>
        <div>
          <h3
          ...
          <p className="text-xl text-stone-600">
            Whether you're looking to buy, sell, or simply explore, TrustysBid
        ...
        <div>
          <p className="text-[#d6482b] text-xl font-bold mb-3">
            Thank you for choosing TrustysBid. We look forward to being a part of
