...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      description:
        "After winning an item, the highest bidder will receive an email with the Auctioneer's payment method information, bank transfer.",
    },
    {
      icon: <FaDollarSign />,
  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        ...
        >
          Discover How TrustysBid Operates
        </h1>
